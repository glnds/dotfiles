...
suite('Auto Completion Tests', () => {
    ...
    describe('YAML Completion Tests', function () {
        ...
        describe('Bug fixes', () => {
            it('Object in array completion indetetion', () => __awaiter(this, void 0, void 0, function* () {
                languageService.addSchema(testHelper_1.SCHEMA_ID, {
                    type: 'object',
                    properties: {
                        components: {
            ...
            it('should provide completion for empty file', () => __awaiter(this, void 0, void 0, function* () {
                languageService.addSchema(testHelper_1.SCHEMA_ID, {
                    oneOf: [
                        {
                            type: 'object',
